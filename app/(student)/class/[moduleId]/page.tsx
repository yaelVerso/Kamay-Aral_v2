...
export default async function ClassModulePage({ params }: { params: Promise<{ moduleId: string }> }) {
  ...
  return (
    <div className="px-4 pt-6 pb-4">
      <Link href="/class" className="mb-4 flex items-center gap-1 text-base text-muted-foreground hover:text-foreground">
            ...
            <div key={sm.id} className="rounded-2xl bg-[#FDEFCA] shadow-[0_4px_0_#EFD385] overflow-hidden">
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <Link
                    href={`/class/${moduleId}/${sm.id}/learn`}
                  ...
                  <Link
                    href={`/class/${moduleId}/${sm.id}/activity`}
                ...
                <div className="mt-3">
                  {quizEnabled && !attempt ? (
                    <Link
                      href={`/class/${moduleId}/${sm.id}/quiz`}
