...
const submodule: SubModule = {
  ...
  items: [
    { id: 'color-red', label: 'Red', videoPath: videoUrl('/videos/colors-shapes/red.mp4'), acceptedAnswers: ['red'] },
    { id: 'color-blue', label: 'Blue', videoPath: videoUrl('/videos/colors-shapes/blue.mp4'), acceptedAnswers: ['blue'] },
    { id: 'color-yellow', label: 'Yellow', videoPath: videoUrl('/videos/colors-shapes/yellow.mp4'), acceptedAnswers: ['yellow'] },
