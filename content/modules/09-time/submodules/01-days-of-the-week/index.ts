...
const submodule: SubModule = {
  ...
  items: [
    { id: 'day-monday', label: 'Monday', videoPath: videoUrl('/videos/time/monday.mp4'), acceptedAnswers: ['monday'] },
    { id: 'day-tuesday', label: 'Tuesday', videoPath: videoUrl('/videos/time/tuesday.mp4'), acceptedAnswers: ['tuesday'] },
    { id: 'day-wednesday', label: 'Wednesday', videoPath: videoUrl('/videos/time/wednesday.mp4'), acceptedAnswers: ['wednesday'] },
