...
const submodule: SubModule = {
  ...
  items: [
    { id: 'question-who', label: 'Who', videoPath: videoUrl('/videos/questions-pronouns/who.mp4'), acceptedAnswers: ['who'] },
    { id: 'question-what', label: 'What', videoPath: videoUrl('/videos/questions-pronouns/what.mp4'), acceptedAnswers: ['what'] },
    { id: 'question-where', label: 'Where', videoPath: videoUrl('/videos/questions-pronouns/where.mp4'), acceptedAnswers: ['where'] },
